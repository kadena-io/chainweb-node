...
mkWebPactExecutionService hm = WebPactExecutionService $ PactExecutionService
    ...
    , _pactReadOnlyReplay = \parity l u -> withChainService (_chainId l) $ \p -> _pactReadOnlyReplay p parity l u
    }
  where
...
mkPactExecutionService q = PactExecutionService
   ...
   , _pactReadOnlyReplay = \parity l u -> pactReadOnlyReplay parity l u q
    }
