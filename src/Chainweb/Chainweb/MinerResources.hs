  ...
  where
    ...
    primeWork tpw cid =
      ...
      where
        ...
        go miner = do
            ...
            newPayload <- getPayload (ParentHeader new) cid miner
            atomically $ modifyTVar' tpw (ourMiner .~ over _2 Just newPayload)
    ...
    getPayload new cid m =
        ...
        then return $ T2 new $ payloadWithOutputsToPayloadData emptyPayload
            ...
            () 1 (second payloadWithOutputsToPayloadData <$> _pactNewBlock pact cid m)
