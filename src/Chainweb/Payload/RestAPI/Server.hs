...
heightedPayloadBatchHandler
    :: CanReadablePayloadCas tbl
    => PayloadBatchLimit
    -> PayloadDb tbl
    -> [(BlockHeight, BlockPayloadHash)]
    -> Handler [PayloadData]
heightedPayloadBatchHandler batchLimit db ks =
...
payloadServer batchLimit (PayloadDb' db)
    ...
    :<|> heightedPayloadBatchHandler @tbl batchLimit db
