...
execTransactions nonGenesisParentHeaderCurrCreate !miner !ctxs !enfCBFail !usePrecomp
                 (PactDbEnv' pactdbenv) = do
    !mc <- use psInitCache
    !coinOut <- runCoinbase nonGenesisParentHeaderCurrCreate pactdbenv miner
                    enfCBFail usePrecomp mc
