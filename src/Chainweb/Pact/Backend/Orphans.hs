...
deriving instance (Generic n, Serial n) => Serial (BindType (Type (Term n)))
deriving instance (Generic n, Serial n) => Serial (Term n)
deriving instance (Generic n, Serial n) => Serial (FunType (Term n))
deriving instance (Generic n, Serial n) => Serial (ConstVal (Term n))
deriving instance (Generic n, Serial n) => Serial (App (Term n))
deriving instance (Generic n, Serial n) => Serial (TypeVar (Term n))
...
deriving instance (Generic n, Serialize n) => Serialize (Type (Term n))
deriving instance Serialize SchemaType
deriving instance Serialize PrimType
deriving instance Serialize GuardType
deriving instance (Generic n, Serialize n) => Serialize (FunType (Term n))
deriving instance (Generic n, Serialize n) => Serialize (Arg (Term n))
deriving instance (Generic n, Serialize n) => Serialize (TypeVar (Term n))
...
deriving instance (Generic n, Serialize n) => Serialize (FunTypes (Term n))
