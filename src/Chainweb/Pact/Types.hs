...
blockInProgressParent :: BlockInProgress -> Parent (BlockHash, BlockHeight, BlockCreationTime)
blockInProgressParent bip = Parent $
    maybe
    (unwrapParent (genesisParentBlockHash v cid), genesisHeight v cid, v ^?! versionGenesis . genesisTime . atChain cid)
