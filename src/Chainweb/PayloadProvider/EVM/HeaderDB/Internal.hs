...
--
-- Do not import this module directly. Instead use "Chainweb.PayloadProvider.EVM.HeaderDB".
--
-- Internal EVM Header DB implementation. This module must be imported only by
-- modules within the @Chainweb.PayloadProvider.EVM.HeaderDB@ namespace.
--
module Chainweb.PayloadProvider.EVM.HeaderDB.Internal
(
-- * EVM Header DB
...
decodeRankedHeader bs = case get getRlp bs of
    Left e -> throwM $ DecodeException $ (T.pack e)
    Right x -> return $ RankedHeader x
