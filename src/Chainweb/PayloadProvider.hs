...
blockHeaderToEvaluationCtx
    ...
    -> BlockPayloadHash
    -> EvaluationCtx
blockHeaderToEvaluationCtx (ParentHeader ph) pld = EvaluationCtx
    ...
    , _evaluationCtxPayloaddData = Nothing
    }
  where
...
withPayloadProvider
    ...
    -> a
withPayloadProvider (PayloadProviders ps) cid f = case HM.lookup cid ps of
