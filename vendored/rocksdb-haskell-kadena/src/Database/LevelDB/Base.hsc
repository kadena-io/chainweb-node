...
foreign import ccall unsafe "leveldb/c.h leveldb_options_set_comparator"
  c_leveldb_set_comparator :: OptionsPtr -> ComparatorPtr -> IO ()
...
type StatePtr   = Ptr ()
type Destructor = FunPtr (StatePtr -> ())
type CompareFun = FunPtr (StatePtr -> CString -> CSize -> CString -> CSize -> CInt)
type NameFun    = FunPtr (StatePtr -> CString)
