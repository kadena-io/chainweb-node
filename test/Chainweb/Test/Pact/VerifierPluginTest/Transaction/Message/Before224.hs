...
module Chainweb.Test.Pact.VerifierPluginTest.Transaction.Message.Before224 (tests) where
  ...
  runBlockTest
    ...
    , PactTxTest
      ...
      (\cr -> liftIO $ do
        ...
        assertEqual "gas should have been charged" 16535 (_crGas cr))
    ]
