...
tests = testGroup "Chainweb.Test.Pact.SPV"
    ...
    [ testGroup "hyperlane"
      ...
      , testCase "decodeTokenMessageERC721" hyperlaneDecodeTokenMessageERC721
...
hyperlaneEncodeTokenMessageERC20 = do
  ...
  case res of
    ...
    Right o ->
      let
        expectedMessage :: Text = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAEAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAFwAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAJcmVjaXBpZW50AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="
...
hyperlaneDecodeTokenMessageERC721 = do
  let
    encodedMessage :: Text = ""
    obj' = mkObject
        [ ("cmd", tStr $ asString ("decodeTokenMessageERC721" :: Text))
        , ("arg", obj [ ("encodedMessage", tStr $ asString encodedMessage) ])
        ]
  res <- runExceptT $ evalHyperlaneCommand obj'
...
hyperlaneEncodeHyperlaneMessage = do
  ...
  case res of
    ...
    Right o ->
      let
        expectedMessage :: Text = ""
        expectedObject = mkObject
          [ ("message", tStr $ asString expectedMessage)
          , ("messageId", tStr $ asString ("CNTz3Ui/oG09bU5VGtGYpQLtF+A0D8kyypeq77Tqxbs=" :: Text))
          ]
      in assertEqual "should get encoded message" expectedObject o
...
hyperlaneDecodeHyperlaneMessage = do
  ...
  let
    tokenMessage :: Text = ""
    expectedObject = mkObject
...
hyperlaneVerifyHyperlaneMessage = do
  let
    encodedMessage :: Text = ""
    encodedMetadata :: Text = ""
    obj' = mkObject
  ...
  let
    expectedObject = mkObject
      [ ("addresses", toTList TyAny def [ tStr $ asString ("0xa9ca6bb5cf232dbbef7f861f8b30da7720f226a0" :: Text) ])
      ]
  case res of
    Left _ -> assertFailure "Should get the result"
    Right o -> assertEqual "Should properly decode the object" expectedObject o
