...
type HasFixture = (?remotePactTestFixture :: IO Fixture, CutFixture.HasFixture)

withFixture' :: IO Fixture -> (HasFixture => a) -> a
withFixture' fixture tests =
    let ?remotePactTestFixture = fixture
    in CutFixture.withFixture' (_cutFixture <$> fixture) tests
