...
import Chainweb.Pact.Backend.PactState (pactDiffMain, pactBreakdownMain)
...
topLevelCommands =
  ...
  , CommandSpec
      "pact-breakdown"
      "Show a breakdown of the Pact State"
      Chainweb.Pact.Backend.PactState.pactBreakdownMain
  , CommandSpec
      "calculate-release"
