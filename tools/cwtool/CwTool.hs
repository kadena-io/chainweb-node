...
import Chainweb.Pact.Backend.PactState (main)
import Chainweb.Pact.Backend.PactState.SizeInfo (main)
...
topLevelCommands =
  ...
  , CommandSpec
      "pact-breakdown"
      "Show a detailed breakdown of the Pact State"
      Chainweb.Pact.Backend.PactState.SizeInfo.main
  , CommandSpec
      "calculate-release"
